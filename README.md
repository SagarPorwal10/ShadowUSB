...
## 📦 Building the Executable (Portable Mode)
...
ShadowUSB/
├── core/
│   ├── scanner.py       # Registry extraction logic
│   ├── log_parser.py    # SetupAPI log parsing
│   ├── user_tracker.py  # User hive analysis (Offline/Online)
│   ├── drive_mapper.py  # Binary registry parsing
│   └── correlator.py    # Data merging logic
├── reports/
│   ├── csv_exporter.py
│   └── excel_exporter.py
├── utils/
│   └── user_utils.py    # SID to Username resolution
├── main.py              # Entry point
└── README.md
